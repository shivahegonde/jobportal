...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo logo-bg">
      ...
      <span class="logo-lg"><b>ShivGuru</b>.Tech</span>
    </a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center latest-job margin-bottom-20">
            <h1>Candidates</h1>
            <h4><b>&nbsp</h4> 
            <h4>“Success seems to be connected to action. Successful people keep moving. They make mistakes, but they never quit.”</h4>            
            <p></p>  
            <p></p>         
            <h4><b>—J.W. Marriot</h4>            
          </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-4 col-md-4">
            <div class="thumbnail candidate-img">
              <img src="img/interviewed.jpeg" alt="Apply">
              <div class="caption">
        ...
        <div class="row">
              <form method="post" action="sendmessage.php">
                <div class="col-md-12 latest-job ">
                  ...
                  <div class="form-group">
                <input type="number" class="form-control  input-lg" id="mobile" name="mobile" placeholder="Enter Mobile Number" pattern="[6789][0-9]{9}" required="">
                  </div>
                  <div class="form-group">
